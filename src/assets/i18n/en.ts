  ...
  TRANSLATE: {
    ...
    HOME: {
      ...
      GRAPHIC_CARD: {
        ...
        TOTAL_OF_MARKET_CAP: 'Market Cap',
        TOTAL_OF_VOLUME: 'Volume in 24h ',
    ...
    ABOUT: {
      TITLE: 'About',
      COMMENTS:
        'This Crypto-Tracker App has the main goal to track the development of different crypto-coins (at the moment about 200). I hope you enjoy it!',
    },
    FOOTER: {
